...
const n = $('#navigation').innerWidth();
$('#navigation').animate({ left: `-${n}` });

$('#navChange .navChangeIcon').click(function (e) {
  e.preventDefault();



  if ($('#navigation').css('left') == '0px') {
    $('#navigation').animate({ left: `-${n}` }, 'slow');
    $('#navChange .navChangeIcon').removeClass('fa-x')
    $('#navChange .navChangeIcon').addClass('fa-bars')
    ...
    $('#navChange .navChangeIcon').removeClass('fa-bars')
    $('#navChange .navChangeIcon').addClass('fa-x')
